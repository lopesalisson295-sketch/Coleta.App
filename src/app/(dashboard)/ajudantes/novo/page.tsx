...
export default function NovoAjudantePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setErro(data.error || 'Erro ao cadastrar ajudante');
      }
    } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Novo Ajudante</h1>
          <p className="text-muted-foreground">Adicione um novo ajudante de carga à equipe.</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex justify-end pt-3">
            ...
            >
              ...
              {isLoading ? 'Cadastrando...' : 'Cadastrar Ajudante'}
            </Button>
          </div>
        </form>
      </Card>
