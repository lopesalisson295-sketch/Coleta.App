  ...
  const carregarDados = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const found = motoristas.find((m: any) => m.id === id);
        if (found) {
          setForm({
            nome: found.nome,
            email: found.email,
        ...
        setErro('Erro ao buscar dados do motorista');
      }
    } catch (error) {
    ...
    <div className="max-w-2xl mx-auto space-y-6 pb-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Atualize as informações cadastrais e de acesso.</p>
        </div>
      </div>
          ...
          <div className="flex items-center space-x-3 p-4 rounded-xl border border-secondary bg-secondary/10">
            ...
            <div className="grid gap-0.5 leading-none">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Marcar se o motorista já concluiu a configuração do seu perfil operacional.
              </p>
            </div>
          </div>
